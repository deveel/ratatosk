namespace Ratatosk
{
    ...
    /// the Facebook Messenger connector.
    /// </summary>
    public static class FacebookMessengerBuilderExtensions
    {
        /// <summary>
        /// Adds the Facebook Messenger connector to the messaging builder.
        /// </summary>
        ...
        /// <summary>
        /// Adds the Facebook Messenger connector with a connection string.
        /// </summary>
        /// <param name="builder">The messaging builder.</param>
        ...
        /// <summary>
        /// Adds the Facebook Messenger connector with configuration.
        /// </summary>
        /// <param name="builder">The messaging builder.</param>
        ...
        /// <summary>
        /// Adds a named Facebook Messenger connector with configuration.
        /// </summary>
        /// <param name="builder">The messaging builder.</param>
        ...
        /// <summary>
        /// Adds a named Facebook Messenger connector with a connection string.
        /// </summary>
        /// <param name="builder">The messaging builder.</param>
        /// <param name="name">The name of the connector instance.</param>
        /// <param name="connectionString">The connection string for the connector.</param>
