...
namespace Ratatosk
{
	...
	public sealed class ChannelDescriptor
	{
		...
		/// <summary>
		/// Determines whether this channel supports the specified authentication scheme.
		/// </summary>
		/// <param name="scheme">The authentication scheme to check.</param>
		/// <returns><c>true</c> if the channel supports the scheme.</returns>
		public bool SupportsAuthenticationScheme(AuthenticationScheme scheme)
		{
			return MasterSchema.SupportsAuthenticationScheme(scheme);
		}
