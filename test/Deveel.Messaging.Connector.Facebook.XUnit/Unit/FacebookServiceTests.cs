...
public class FacebookServiceTests
{
    ...
    [Fact]
    public void Should_ReturnTrue_When_ValidatePageAccessTokenValidTokens()
    {
    ...
    [Fact]
    public void Should_ReturnFalse_When_ValidatePageAccessTokenInvalidTokens()
    {
    ...
    [Fact]
    public void Should_CreateCorrectStructure_When_BuildFacebookMessagePayloadValidRequest()
    {
        var request = new FacebookMessageRequest
        {
            Recipient = "user-123",
    ...
    [Fact]
    public void Should_CreateCorrectStructure_When_BuildMessageContentWithTextAndQuickReplies()
    {
    ...
    [Fact]
    public void Should_CreateCorrectStructure_When_BuildMessageContentWithAttachment()
    {
        // Test internal method directly
        var message = new FacebookMessage
        {
    ...
    [Fact]
    public void Should_ReturnFormattedMessage_When_ParseFacebookErrorValidErrorResponse()
    {
        // Test internal method directly
    ...
    [Fact]
    public void Should_ReturnSimpleFormat_When_ParseFacebookErrorErrorWithoutSubcode()
    {
        // Test internal method directly
        var mockResponse = new Mock<RestResponse>();
        mockResponse.Object.Content = @"{
    ...
    [Fact]
    public void Should_ReturnHttpStatus_When_ParseFacebookErrorEmptyContent()
    {
        // Test internal method directly
    ...
    [Fact]
    public void Should_ReturnRawContent_When_ParseFacebookErrorInvalidJson()
    {
        // Test internal method directly
        var mockResponse = new Mock<RestResponse>();
    ...
    [Fact]
    public void Should_ReturnValue_When_GetJsonStringPropertyExistingProperty()
    {
        // Test internal method directly
    ...
    [Fact]
    public void Should_ReturnNull_When_GetJsonStringPropertyNonExistingProperty()
    {
        // Test internal method directly
    ...
    [Fact]
    public void Should_DoNotIncludeProperty_When_BuildFacebookMessagePayloadWithDefaultNotificationType()
    {
        // Test internal method directly
        var request = new FacebookMessageRequest
        {
    ...
    [Fact]
    public void Should_IncludeProperty_When_BuildFacebookMessagePayloadWithNonDefaultNotificationType()
    {
        // Test internal method directly
        var request = new FacebookMessageRequest
        {
    ...
    [Fact]
    public void Should_IncludeTagProperty_When_BuildFacebookMessagePayloadWithTag()
    {
        // Test internal method directly
        var request = new FacebookMessageRequest
        {
    ...
    [Fact]
    public void Should_DoNotIncludeImageUrl_When_BuildMessageContentWithQuickReplyWithoutImageUrl()
    {
        // Test internal method directly
        var message = new FacebookMessage
        {
