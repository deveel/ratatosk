...
namespace Deveel.Messaging
{
    ...
    {
        [Fact]
        public async Task SendMessageAsync_WithValidMessage_CallsFirebaseService()
        {
            // Arrange
        ...
        [Fact]
        public async Task SendMessageAsync_WithValidCustomData_ParsesCorrectly()
        {
            // Arrange
            var mockFirebaseService = CreateInspectingMockFirebaseService();
            var connector = await CreateInitializedConnectorAsync(mockFirebaseService.Object);
        ...
        [Fact]
        public async Task SendMessageAsync_WithAndroidProperties_ConfiguresCorrectly()
        {
            // Arrange
            var mockFirebaseService = CreateInspectingMockFirebaseService();
            var connector = await CreateInitializedConnectorAsync(mockFirebaseService.Object);
        ...
        [Fact]
        public async Task SendMessageAsync_WithIOSProperties_ConfiguresCorrectly()
        {
            // Arrange
            var mockFirebaseService = CreateInspectingMockFirebaseService();
            var connector = await CreateInitializedConnectorAsync(mockFirebaseService.Object);
        ...
        [Fact]
        public async Task SendMessageAsync_WithInvalidCustomData_FailsValidation()
        {
            // Arrange
            var mockFirebaseService = CreateInspectingMockFirebaseService();
            var connector = await CreateInitializedConnectorAsync(mockFirebaseService.Object);
        ...
        [Fact]
        public async Task SendMessageAsync_WithDryRun_PassesCorrectFlag()
        {
            // Arrange
            var mockFirebaseService = CreateInspectingMockFirebaseService();
            var connector = await CreateInitializedConnectorAsync(mockFirebaseService.Object);
            ...
            // Assert - Should use dry run from connection settings (true by default)
            mockFirebaseService.Verify(x => x.SendAsync(
                It.IsAny<FirebaseAdmin.Messaging.Message>(),
