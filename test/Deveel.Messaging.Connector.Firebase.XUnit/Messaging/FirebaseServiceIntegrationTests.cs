...
namespace Deveel.Messaging
{
    ...
    public class FirebaseServiceIntegrationTests : IDisposable
    {
        ...
        [Fact]
        public void CreateComplexFirebaseMessage_WithAllProperties_ConstructsCorrectly()
        {
            // Arrange & Act
        ...
        [Fact]
        public void CreateTopicMessage_WithTopicTargeting_ConstructsCorrectly()
        {
            // Arrange & Act
        ...
        [Fact]
        public void CreateDataOnlyMessage_WithoutNotification_ConstructsCorrectly()
        {
            // Arrange & Act
        ...
        [Fact]
        public void CreateMulticastMessage_WithMultipleTokens_ConstructsCorrectly()
        {
            // Arrange
        ...
        [Fact]
        public void MultipleServices_IndependentInitialization_MaintainSeparateStates()
        {
            // Arrange
            ...
            // Act & Assert - All should start uninitialized
        ...
        [Fact]
        public async Task Service_TestConnectionBeforeInitialization_ReturnsFalseConsistently()
        {
            // Arrange
        ...
        [InlineData("   ")]
        [InlineData("\t\n")]
        public async Task InitializeAsync_WithInvalidServiceAccountKeys_ThrowsAppropriateException(string invalidKey)
        {
            // Arrange
            var service = CreateService();
        ...
        [InlineData("   ")]
        [InlineData("\t\n")]
        public async Task InitializeAsync_WithInvalidProjectIds_ThrowsAppropriateException(string invalidProjectId)
        {
            // Arrange
            var service = CreateService();
        ...
        [Fact]
        public async Task InitializeAsync_WithValidJsonStructure_HandlesCorrectly()
        {
            // Arrange
            var service = CreateService();
            var wellFormedJson = """
            ...
            // Act & Assert - Should attempt initialization but fail due to invalid key content
        ...
        [Fact]
        public async Task InitializeAsync_WithMalformedJson_ThrowsInvalidOperationException()
        {
            // Arrange
            var service = CreateService();
            var malformedJson = """
        ...
        [Fact]
        public void ValidateFirebaseMessage_WithRequiredFields_PassesBasicStructure()
        {
            // Arrange & Act
            ...
            // Assert - Message should have required structure
        ...
        [Fact]
        public void ValidateFirebaseMessage_WithLargeDataPayload_StructureIsCorrect()
        {
            // Arrange
        ...
        [Fact]
        public async Task ServiceOperations_WhenNotInitialized_ProvideConsistentErrorMessages()
        {
            // Arrange
            var service = CreateService();
        ...
        [Fact]
        public async Task TestConnectionAsync_ConcurrentCalls_HandleGracefully()
        {
            // Arrange
            var service = CreateService();

            // Act - Test connection concurrently
            ...
            // Assert - All should return false since service is not initialized
            Assert.True(results.All(r => !r), "All concurrent connection tests should return false");
        }

        [Fact]
        public async Task ServiceOperations_WithCancellation_RespondToCancellation()
        {
            // Arrange
            var service = CreateService();
            ...
            // Act & Assert - Firebase service checks initialization before cancellation
