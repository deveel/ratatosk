...
namespace Deveel.Messaging
{
	...
	public class TelegramBotConnectorIntegrationTests
	{
		...
		[Fact]
		public async Task SendMessageAsync_WithInlineKeyboard_ShouldIncludeKeyboard()
		{
			// Arrange
		...
		[Fact]
		public async Task SendMessageAsync_WithValidInlineKeyboardJson_ShouldSucceed()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task SendMessageAsync_WithReplyMarkup_ShouldIncludeReplyMarkup()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task SendMessageAsync_WithMediaAndCaption_ShouldSendWithCaption()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		public async Task SendMessageAsync_WithDifferentMediaTypes_ShouldSendCorrectly(MediaType mediaType)
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task SendMessageAsync_WithLocationAndAllProperties_ShouldSendWithAllProperties()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[InlineData("HTML")]
		[InlineData("None")]
		public async Task SendMessageAsync_WithDifferentParseModes_ShouldRespectParseMode(string parseMode)
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task SendMessageAsync_WithJSONLocationContent_ShouldSendLocation()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithTextMessage_ShouldParseCorrectly()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithPhotoMessage_ShouldParseCorrectly()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithLocationMessage_ShouldParseCorrectly()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithEditedMessage_ShouldParseCorrectly()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithReplyMessage_ShouldIncludeReplyInfo()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task InitializeAsync_WithWebhookAndSecretToken_ShouldConfigureCorrectly()
		{
			// Arrange
		...
		[Fact]
		public async Task GetStatusAsync_WithWebhook_ShouldIncludeWebhookInfo()
		{
			// Arrange
			var schema = TelegramChannelSchemas.WebhookBot;
		...
		[Fact]
		public async Task SendMessageAsync_WhenTelegramServiceThrows_ShouldReturnFailureResult()
		{
			// Arrange
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithMalformedJson_ShouldFail()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
		...
		[Fact]
		public async Task ReceiveMessagesAsync_WithEmptyWebhookData_ShouldFail()
		{
			// Arrange
			var connector = await CreateInitializedConnectorAsync();
			var emptyJson = "{}";
