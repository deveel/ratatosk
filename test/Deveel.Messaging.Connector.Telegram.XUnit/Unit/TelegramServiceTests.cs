...
namespace Deveel.Messaging
{
	...
	public class TelegramServiceTests
	{
		...
		[Fact]
		public void Should_CreateService_When_ConstructorWithNullBotClient()
		{
			// Act
		...
		[Fact]
		public void Should_CreateService_When_ConstructorWithMockBotClient()
		{
			// Arrange
		...
		[Fact]
		public void Should_Succeed_When_InitializeWithValidToken()
		{
			// Arrange
		...
		[InlineData("")]
		[InlineData("   ")]
		public void Should_ThrowArgumentNullException_When_InitializeWithInvalidToken(string? token)
		{
			// Arrange
			var service = new TelegramService();
		...
		public void Should_ThrowArgumentException_When_InitializeWithInvalidTokenFormat(string token)
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public void Should_DoNotOverwriteExistingClient_When_InitializeWithInjectedBotClient()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public void Should_CreateNewBotClient_When_InitializeWithNullBotClient()
		{
			// Arrange
			var service = new TelegramService(null);
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_GetMeAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SendTextMessageAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SendPhotoAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SendVideoAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SendAudioAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SendDocumentAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SendLocationAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_SetWebhookAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_DeleteWebhookAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_GetWebhookInfoAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_ThrowInvalidOperationException_When_GetUpdatesAsyncWithoutInitialization()
		{
			// Arrange
			var service = new TelegramService();
		...
		[Fact]
		public async Task Should_CallsBotClient_When_GetMeAsyncWithInitializedService()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
		...
		[Fact]
		public async Task Should_CallsBotClient_When_SendTextMessageAsyncWithInitializedService()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
		...
		[Fact]
		public async Task Should_CallsBotClientWithParseMode_When_SendTextMessageAsyncWithParseMode()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallsBotClient_When_SendPhotoAsyncWithInitializedService()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallsBotClient_When_GetWebhookInfoAsyncWithInitializedService()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
		...
		[Fact]
		public async Task Should_CallsBotClient_When_DeleteWebhookAsyncWithInitializedService()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallsBotClient_When_GetUpdatesAsyncWithInitializedService()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
		...
		[Fact]
		public async Task Should_CallBotClient_When_SendPhotoAsyncWithBasicParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_SendPhotoAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_UseCorrectOverload_When_SendPhotoAsyncWithParseMode()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_PropagateException_When_SendPhotoAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClient_When_SendVideoAsyncWithBasicParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_SendVideoAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_UseCorrectOverload_When_SendVideoAsyncWithoutParseMode()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_PropagateException_When_SendVideoAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClient_When_SendAudioAsyncWithBasicParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_SendAudioAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_UseCorrectOverload_When_SendAudioAsyncWithoutParseMode()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_PropagateException_When_SendAudioAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClient_When_SendDocumentAsyncWithBasicParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_SendDocumentAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_UseCorrectOverload_When_SendDocumentAsyncWithoutParseMode()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_PropagateException_When_SendDocumentAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClient_When_SendLocationAsyncWithBasicParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_SendLocationAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var expectedMessage = TelegramMockFactory.CreateTestTelegramMessage();
		...
		[Fact]
		public async Task Should_PropagateException_When_SendLocationAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClient_When_SetWebhookAsyncWithBasicUrl()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_SetWebhookAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_PropagateException_When_SetWebhookAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public async Task Should_CallBotClientWithAllParameters_When_GetUpdatesAsyncWithAllParameters()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
		...
		[Fact]
		public async Task Should_PropagateException_When_GetUpdatesAsyncBotClientThrowsException()
		{
			// Arrange
			var mockBotClient = new Mock<ITelegramBotClient>();
			var service = new TelegramService(mockBotClient.Object);
		...
		[Fact]
		public void Should_ThrowInvalidOperationException_When_EnsureInitializedWithNullBotClient()
		{
			// Arrange
			var service = new TelegramService();
